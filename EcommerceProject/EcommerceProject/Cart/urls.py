...
from EcommerceProject.Cart.views import add_to_cart, show_cart, minus_cart, remove_cart, plus_cart, \
    minus_wishlist, plus_wishlist, search, wishlist, search_predictions, Checkout
